...
- Adjacent repository-agent or issue-resolution records that were checked after the screening pool was finalized are documented in `notable_boundary_records.csv`; documenting such records does not add them to the 474-record screening denominator or the 66-system corpus.
